<?php
/*
	Template Name: UX Consulting Page Template
*/
get_header();
...
if( has_post_thumbnail() )
{
  $serviceBannerImage = get_the_post_thumbnail_url( get_the_ID(), 'large' );
    ...
    if( have_rows('acf_flx_uxc_page_content') ):
        while ( have_rows('acf_flx_uxc_page_content') ) : the_row();
            if( get_row_layout() == 'acf_flx_uxc_hs_hero_section' ):
                ...
                <?php
            elseif( get_row_layout() == 'acf_flx_uxc_cwws_client_we_work_with_section' ): 
                ?>
                    <div class="max-w-screen-2xl px-5 mx-auto [mask:linear-gradient(90deg,transparent,white_20%,white_80%,transparent)] w-full">
                        <h2 class="text-lg sm:text-2xl md:text-4xl xl:text-[54px] font-criteria font-semibold dark:text-white text-grayDark pb-6 !leading-[1] sm:pb-10 md:pb-[60px] text-center">
                          <?php echo get_sub_field("acf_flx_uxc_cwws_section_title"); ?>
                       </h2>
                       <div class="w-max flex flex-row gap-24 brand-animation">
                            <?php
                              if( have_rows('acf_flx_uxc_cwws_section_listing') ):
                                while( have_rows('acf_flx_uxc_cwws_section_listing') ) : the_row();
                ...
                <?php
            elseif( get_row_layout() == 'acf_flx_uxc_cs_checkbox_section' ): 
                ?>
                    <!-- Checkboxes -->
                    <div class="max-w-screen-2xl mx-auto px-4">
                        <div class="flex flex-col gap-4 md:gap-5 items-center justify-center text-center">
                            <h2 class="text-lg sm:text-2xl md:text-4xl xl:text-[54px] font-criteria font-semibold dark:text-white text-grayDark leading-none text-center">
                                <?php echo get_sub_field("acf_flx_uxc_cs_section_title"); ?>
                            </h2>
                            <p class="md:text-xl xl:text-2xl xl:leading-10 max-w-5xl text-grayDark dark:text-white">
                                <?php echo get_sub_field("acf_flx_uxc_cs_section_content"); ?>
                            </p>
                            <div class="mt-4 md:mt-[60px] gap-4 md:gap-[33px] grid xl:grid-cols-2">
                                <?php
                                    if( have_rows('acf_flx_uxc_cs_section_listing') ):
                                        while( have_rows('acf_flx_uxc_cs_section_listing') ) : the_row();
                                            ?>
                                                <label
                                                    for="checkbox2"
                                                ...
                                                >
                                                    ...
                                                    <p class="text-sm md:text-[22px] font-medium leading-[24px] md:leading-[44px] opacity-60">
                                                        <?php echo get_sub_field("acf_flx_uxc_cs_listing_title"); ?>
                                                    </p>
                                                </label>
                                            <?php
                                        endwhile;
                ...
                <?php
            elseif( get_row_layout() == 'acf_flx_uxc_ctass_cta_single_section' ): 
                ?>
                    <!-- Yellow CTA -->
                    <div class="px-5">
                        <div class="max-w-screen-2xl mx-auto relative p-5 md:p-10 rounded-md md:rounded w-full bg-primary">
                            ...
                            <div class="flex items-center gap-4 flex-col xl:flex-row justify-center md:justify-between">
                                <h2 class="text-lg font-bold max-w-5xl md:text-[30px] text-center xl:text-left dark:text-grayDark">
                                    <?php echo get_sub_field("acf_flx_uxc_ctass_section_title"); ?>
                                </h2>
                                <a href="<?php echo get_sub_field("acf_flx_uxc_ctass_section_button_url"); ?>">
                                    <button class="hover:scale-105 transition-all duration-500 relative z-10 group font-medium bg-black text-white text-sm md:text-lg rounded-2xl">
                                        <div class="relative overflow-hidden">
                                            <span class="group-hover:translate-y-full p-4 w-full h-full group-hover:rotate-[16deg] origin-bottom-left transition-all grid place-content-center duration-500 pointer-events-none">
                                                <?php echo get_sub_field("acf_flx_uxc_ctass_section_button_title"); ?>
                                            </span>
                                            <span
                ...
                <?php
            elseif( get_row_layout() == 'acf_flx_uxc_nfss_not_find_solution_section' ): 
                ?>
                    <!-- Solutions -->
                        ...
                        <div class="bg-[#FAFAFA] dark:bg-[#0D0A0A] py-[60px] md:py-[100px]">
                            <div class="max-w-screen-2xl mx-auto px-4">
                                <div class="flex flex-col gap-5 items-center justify-center text-center">
                                    <h2 class="text-lg sm:text-2xl md:text-4xl xl:text-[54px] font-criteria font-semibold dark:text-white text-grayDark leading-none text-center">
                                        <?php echo get_sub_field("acf_flx_uxc_nfss_section_title"); ?>
                                    </h2>
                                    <p class="text-sm md:text-xl xl:text-2xl xl:leading-10 max-w-5xl text-grayDark dark:text-white">
                                        <?php echo get_sub_field("acf_flx_uxc_nfss_section_sub_title"); ?>
                                    </p>
                                    <div
                                    ...
                                    >
                                        <?php
                                            if( have_rows('acf_flx_uxc_nfss_section_listing') ):
                                                $cnt=1;
                                                while( have_rows('acf_flx_uxc_nfss_section_listing') ) : the_row();
                                                        ...
                                                        <div class="<?php echo $class; ?>">
                                                            <div class="flex flex-col items-center justify-center text-center lg:items-start lg:justify-start lg:text-left gap-1 lg:gap-2 lg:max-w-[80%]">
                                                                <h4 class="lg:text-6xl text-2xl dark:text-primary font-bold lg:leading-[74px] relative overflow-hidden">
                                                                    <span class="group-hover:translate-y-full w-full h-full group-hover:rotate-[0deg] origin-bottom-left transition-all grid duration-500 pointer-events-none"><?php echo get_sub_field("acf_flx_uxc_nfss_listing_title"); ?></span>
                                                                    <span class="absolute bottom-full left-0 -rotate-[0deg] group-hover:rotate-0 origin-bottom-left w-full h-full grid group-hover:translate-y-full transition-all duration-500 pointer-events-none">
                                                                        <?php echo get_sub_field("acf_flx_uxc_nfss_listing_title"); ?>
                                                                    </span>
                                                                </h4>
                                                                <h5 class="text-black/60 dark:text-white lg:text-2xl font-bold relative overflow-hidden">
                                                                    <span class="group-hover:translate-y-full w-full h-full group-hover:rotate-[0deg] origin-bottom-left transition-all grid duration-500 pointer-events-none"><?php echo get_sub_field("acf_flx_uxc_nfss_listing_sub_title"); ?></span>
                                                                    <span class="absolute bottom-full left-0 -rotate-[0deg] group-hover:rotate-0 origin-bottom-left w-full h-full grid group-hover:translate-y-full transition-all duration-500 pointer-events-none">
                                                                        <?php echo get_sub_field("acf_flx_uxc_nfss_listing_sub_title"); ?>
                                                                    </span>
                                                                </h5>
                                                                <p class="text-grayDark leading-[24px] dark:text-white text-sm lg:text-lg lg:mt-3 font-medium lg:leading-8">
                                                                    <?php echo get_sub_field("acf_flx_uxc_nfss_listing_content"); ?>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    <?php
            ...
            elseif( get_row_layout() == 'acf_flx_uxc_cctas_common_cta_section' ): 
                ...
                <?php
            elseif( get_row_layout() == 'acf_flx_uxc_sfc_schedule_free_consultation' ): 
                ?>
                    <!-- Gallery Section -->
                    <div class="relative overflow-hidden z-10 gallery--scroll">
                        <div class="w-full mt-[60px] gap-24 hidden grid-cols-2 lg:grid">
                            <div class="w-full gallery--scroll-img-1 relative z-20 xl:h-[750px] lg:h-[500px] bg-gray-200 rounded-3xl rounded-l-none overflow-hidden" style="transform: none;">
                                <img alt="" loading="lazy" width="1000" height="750" decoding="async" data-nimg="1" class="h-full w-full object-cover" style="color: transparent;" src="<?php echo get_sub_field("acf_flx_uxc_sfc_image_4"); ?>" />
                            </div>
                            <div class="w-full gallery--scroll-img-2 relative z-20 xl:h-[750px] lg:h-[500px] bg-gray-200 rounded-3xl rounded-r- overflow-hidden" style="transform: none;">
                                <img alt="" loading="lazy" width="1000" height="750" decoding="async" data-nimg="1" class="h-full w-full object-cover" style="color: transparent;" src="<?php echo get_sub_field("acf_flx_uxc_sfc_image_3"); ?>" />
                            </div>
                            <div class="w-full gallery--scroll-img-3 relative z-20 xl:h-[750px] lg:h-[500px] bg-gray-200 rounded-3xl rounded-l-none overflow-hidden" style="transform: none;">
                                <img alt="" loading="lazy" width="1000" height="750" decoding="async" data-nimg="1" class="h-full w-full object-cover" style="color: transparent;" src="<?php echo get_sub_field("acf_flx_uxc_sfc_image_2"); ?>" />
                            </div>
                            <div class="w-full gallery--scroll-img-4 relative z-20 xl:h-[750px] lg:h-[500px] bg-gray-200 rounded-3xl rounded-r-none overflow-hidden" style="transform: none;">
                                <img alt="" loading="lazy" width="1000" height="750" decoding="async" data-nimg="1" class="h-full w-full object-cover" style="color: transparent;" src="<?php echo get_sub_field("acf_flx_uxc_sfc_image_1"); ?>" />
                            </div>
                            <div class="absolute gallery--scroll-text -z-0 top-1/2 left-1/2 max-w-[520px] text-center -translate-x-1/2 -translate-y-1/2">
                                <div class="flex flex-col gap-4 items-center">
                                    <h3 class="text-4xl leading-tight font-criteria font-semibold">
                                        <?php echo get_sub_field("acf_flx_uxc_sfc_section_title"); ?>
                                    </h3>
                                    <p class="text-xl leading-[1.6]">
                                        <?php echo get_sub_field("acf_flx_uxc_sfc_section_content"); ?>
                                    </p>
                                    <div class="mt-5">
                                        <a href="<?php echo get_sub_field("acf_flx_uxc_sfc_button_url"); ?>">
                                            <button
                                                class="relative capitalize px-6 py-4 z-10 overflow-hidden hover:shadow-gradientShadow hover:scale-105 rounded-lg group font-bold text-sm leading-[24px] sm:text-base sm:leading-[26px] text-black bg-primary transition-all duration-300"
                                            >
                                                <span><?php echo get_sub_field("acf_flx_uxc_sfc_button_title"); ?></span>
                                                <span class="absolute w-full h-10 bg-white transition-all duration-300 -left-2/3 group-hover:left-2/3 group-hover:bottom-full pointer-events-none blur-2xl -bottom-full rotate-45"></span>
                                            </button>
                                        </a>
                                    </div>
                ...
                <?php
            elseif( get_row_layout() == 'acf_flx_uxc_veads_versatile_expertise_across_diverse_section' ): 
                ?>
                    ...
                    <div class="w-full px-5 sm:px-0">
                        <div class="w-[885px] max-w-full mx-auto text-center md:pb-20 pb-0 flex flex-col items-center justify-center gap-4 sm:gap-6 md:gap-8r">
                            <h2 class="dark:text-white text-grayDark text-lg sm:text-2xl md:text-4xl xl:text-[54px] font-semibold">
                                <?php echo get_sub_field("acf_flx_uxc_veads_section_title"); ?>
                            </h2>
                            <p class="text-sm leading-6 sm:text-base sm:leading-8 md:text-lg md:leading-9 lg:text-xl xl:text-2xl xl:leading-10 md:max-w-5xl text-grayDark dark:text-white">
                                <?php echo get_sub_field("acf_flx_uxc_veads_section_content"); ?>
                            </p>
                        </div>
                        <div class="swiper expertise-slider w-full overflow-hidden py-10">
                            <div class="swiper-wrapper w-full [&>*:nth-child(even)]:!translate-y-10 [&>*:nth-child(odd)]:!-translate-y-10">
                                <?php
                                  if( have_rows('acf_flx_uxc_veads_section_listing') ):
                                        while( have_rows('acf_flx_uxc_veads_section_listing') ) : the_row();
                                            $listing_image = WPCustomClass::GetAcfImage(get_sub_field("acf_flx_uxc_veads_listing_image"),"vector-1.svg");
                                            ?>
                                                    ...
                                                    >
                                                        ...
                                                        <div class="md:pt-[51px] pt-3 relative z-10">
                                                            <h5 class="md:text-[30px] text-base font-extrabold md:leading-10 leading-[26px] text-grayDark dark:text-white md:pb-[10px] pb-1 transition-all duration-500 group-hover:text-primary">
                                                                <?php echo get_sub_field("acf_flx_uxc_veads_listing_title"); ?>
                                                            </h5>
                                                            <p class="md:text-lg md:leading-7 text-xs leading-[22px] font-normal text-content dark:text-white">
                                                                <?php echo get_sub_field("acf_flx_uxc_veads_listing_content"); ?>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="max-w-screen-2xl px-5 mx-auto h-full">
                        <div class="flex flex-col items-center justify-center gap-4 sm:gap-6 md:gap-8 text-center">
                            ...
                            <div class="flex flex-col md:flex-row gap-8 items-center text-left mt-4 md:mt-0">
                                <?php
                                    $case_study = get_sub_field("acf_flx_uxc_odds_case_study_listing");
            ...
            elseif( get_row_layout() == 'acf_flx_uxc_wcs_why_choose_section' ): 
                ...
                <?php
            elseif( get_row_layout() == 'acf_flx_uxc_ops_our_process_section' ): 
                ?>
                    <!-- Process Section -->
                    <div class="px-5 process--scroll">
                        <div class="flex flex-col items-center justify-center gap-4 sm:gap-6 md:gap-8 text-center">
                            <h2 class="text-lg font-criteria text-grayDark dark:text-white sm:text-2xl md:text-4xl xl:text-[54px] font-semibold">
                                <?php echo get_sub_field("acf_flx_uxc_ops_section_title"); ?>
                            </h2>
                            <p class="text-sm leading-6 sm:text-base sm:leading-8 md:text-lg md:leading-9 lg:text-xl xl:text-2xl xl:leading-10 md:max-w-5xl text-grayDark dark:text-white">
                                <?php echo get_sub_field("acf_flx_uxc_ops_section_content"); ?>
                            </p>
                        </div>
                        <div class="overflow-hidden hidden xl:flex pt-[60px]">
                            <h3 class="text-[6.4vw] text-[#343434] dark:text-white font-bold flex flex-col items-center leading-[2.1] justify-center w-full capitalize whitespace-nowrap">
                                <span class="inline-block span1"><?php echo get_sub_field("acf_flx_uxc_ops_process_listing_title_1"); ?></span>
                                <span class="inline-block span2">
                                    <span
                                        ...
                                        "
                                    >
                                        <?php echo get_sub_field("acf_flx_uxc_ops_process_listing_title_2"); ?>
                                    </span>
                                </span>
                                <span class="inline-block span3"><?php echo get_sub_field("acf_flx_uxc_ops_process_listing_title_3"); ?></span>
                            </h3>
                        </div>
                        <div class="overflow-hidden flex xl:hidden pt-[60px]">
                            <h3 class="text-[6.4vw] text-[#343434] dark:text-white font-bold flex flex-col items-center leading-[2.1] justify-center w-full capitalize whitespace-nowrap">
                                <span class="inline-block"><?php echo get_sub_field("acf_flx_uxc_ops_process_listing_title_1"); ?></span>
                                ...
                                <span class="inline-block"><?php echo get_sub_field("acf_flx_uxc_ops_process_listing_title_3"); ?></span>
                            </h3>
                        </div>
                    </div>
                <?php
            elseif( get_row_layout() == 'acf_flx_uxc_cbs_creative_blog_section' ): 
                ...
                <?php
            elseif( get_row_layout() == 'acf_flx_uxc_ts_testimonial_section' ): 
                ?>
                    <div class="max-w-screen-2xl mx-auto px-4 w-full">
                        <div class="w-[885px] max-w-full mx-auto text-center md:pb-[60px] pb-10 flex flex-col items-center justify-center gap-4 sm:gap-6 md:gap-8">
                            <h2 class="dark:text-white text-grayDark lg:pb-0 pb-4 text-lg sm:text-2xl md:text-4xl xl:text-[54px] font-semibold">
